...
Modified by:
Evil0ctal: https://github.com/Evil0ctal/Douyin_TikTok_Download_API
Further adapted for: tool-douyin-emoji
...
class ABogus:
    ...
    def __init__(self, platform: str = None):
        ...
        self.size = 0
        self.reg = self.__reg[:]
        # ua_code for: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36
        self.ua_code = [
            76, 98, 15, 131, 97, 245, 224, 133, 122, 199, 241, 166,
            79, 34, 90, 191, 128, 126, 122, 98, 66, 11, 14, 40, 49,
            110, 110, 173, 67, 96, 138, 252,
        ]
    ...
    @classmethod
    def generate_browser_info(cls, platform: str = "MacIntel") -> str:
        ...
        value_list = [
            ...
            inner_width, inner_height, 24, 24,
            platform,
        ]
